...
_AI_RULES = {
    "es": (
        ...
        "- No afirmes pierna hábil, altura, nacionalidad ni nada que no esté en los datos. El código "
        "de posición (RCB, LW) dice el lado en que juega, no su pierna.\n"
    ...
    "en": (
        ...
        "- Do not state preferred foot, height, nationality or anything not in the data. The position "
        "code (RCB, LW) is the side he plays on, not his foot.\n"
...
_AI_TASKS = {
    ("quick", "es"): (
        ...
        "muestra de minutos es corta (menos de 900) y qué pesa la edad y la liga. Antes de afirmar "
        "una virtud o una carencia, comprueba que ninguna otra métrica o familia la contradiga (una "
        "carencia no puede tener una métrica relacionada por encima del percentil 60, ni una virtud "
        "una por debajo del 40); si el dato está repartido, matízalo o elige otro rasgo. Escribe solo "
        "la conclusión, no el razonamiento.\n\n"
        ...
        "el rol o el contexto en el que rinde. Ese rol tiene que proteger su carencia, no exponerla "
        "(a un central sin velocidad no lo pongas en una línea adelantada).\n"
    ...
    ("quick", "en"): (
        ...
        "whether the minutes sample is short (under 900), and how age and league weigh in. Before "
        "stating a strength or a weakness, check that no other metric or family contradicts it (a "
        "weakness cannot have a related metric above the 60th percentile, nor a strength one below "
        "the 40th); if the evidence is split, qualify it or pick another trait. Write only the "
        ...
        "mean; the role or setting where he performs. That role must shield the weakness, not expose "
        "it (do not put a centre-back without pace in a high line).\n"
