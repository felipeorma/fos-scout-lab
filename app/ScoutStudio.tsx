              ...
              {reportPage === 1 ? <div className="report-workspace">
                <section className="control-panel enrichment-controls">
                  ...
                  <div className="two-fields">
                    <label className="field-group"><FieldLabel>{t("Cohorte")}</FieldLabel><span className="select-wrap simple"><select value={cohort} onChange={(event) => setCohort(event.target.value)}><option value="AUTO">{t("Automática")}</option><option value="GK">{t("Porteros")}</option><option value="CB">{t("Centrales")}</option><option value="FB">{t("Laterales")}</option><option value="MID">{t("Mediocampistas")}</option><option value="WING">{t("Extremos")}</option><option value="AM">{t("Mediapuntas")}</option><option value="CF">{t("Delanteros")}</option></select><ChevronDown size={16} /></span></label>
